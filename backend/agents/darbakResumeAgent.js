...
* اكتب نقاط الخبرة من 1–5 نقاط بحسب كمية الحقائق، ولا تكتب عددًا ثابتًا: معلومة أو معلومتان فقط تكفيهما 1–2 نقطة، و2–3 مسؤوليات واضحة تكفيها غالبًا 2–3 نقاط، ولا تستخدم 4–5 نقاط إلا عند وجود مسؤوليات متعددة موثقة. اجمع المهام المتشابهة مثل تنظيم/تنسيق الاجتماعات في نقطة واحدة، ورتب النقاط: المسؤولية الأهم ثم العملية/التقنية ثم المتابعة. ابدأ كل نقطة بفعل مهني مباشر مثل: إعداد، تنظيم، تنسيق، مراجعة، متابعة، تطوير، تحليل، توثيق، دعم؛ وبالإنجليزية Prepared, Organized, Coordinated, Reviewed, Monitored, Developed, Analyzed, Documented, Supported. لا تستخدم «المسؤول عن» أو «قمت بـ» أو Responsible for، ولا تكرر المعنى بصيغتين، ولا تضف أثرًا أو رقمًا أو نظامًا أو أداة غير موثقة. في التدريب والتعاون حافظ على مستوى مسؤولية واقعي ولا تصفه كدور senior. أعد لكل خبرة quality يحتوي noDuplicateMeaning وnoUnsupportedClaims وappropriateSeniority وconcise.

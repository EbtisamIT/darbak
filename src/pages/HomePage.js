  ...
  return (
    <main className="home-page" dir="rtl">
      <section className="home-hero">
        ...
        <div className="home-hero-layout">
          ...
          {hasSavedJourney && !isChangingJourney && <aside className="home-saved-journey-card">
            ...
            <p>{returningJourneyMessage}</p>
            <small className="home-saved-journey-label">رحلتك في دربك</small>
            <strong>{journeyPreferences.preferredMajor}</strong>
            <small className="home-saved-journey-city">{journeyPreferences.preferredCity}</small>
            <div className="home-saved-journey-actions">
              <Link to={finderUrl()}>استكشف الجهات والفرص <FiArrowLeft /></Link>
      ...
      <style>{`
        ...
        .home-saved-journey-card { display: grid; align-content: center; justify-self: center; gap: 5px; width: min(390px, 100%); padding: 15px; box-sizing: border-box; border: 1px solid var(--app-brand-border); border-radius: 15px; background: var(--app-brand-soft); }.home-saved-journey-card > span { color: var(--app-brand); font-size: 13px; font-weight: 900; }.home-saved-journey-card > p { margin: 0 0 7px; color: var(--app-text); font-size: 15px; font-weight: 850; line-height: 1.6; }.home-saved-journey-card .home-saved-journey-label { color: var(--app-muted); font-size: 11px; font-weight: 800; }.home-saved-journey-card strong { font-size: 19px; line-height: 1.4; }.home-saved-journey-card .home-saved-journey-city { color: var(--app-text-soft); font-size: 12px; }.home-saved-journey-actions { display: flex; align-items: center; flex-wrap: wrap; gap: 8px 14px; margin-top: 7px; padding-top: 9px; border-top: 1px solid var(--app-border-soft); }.home-saved-journey-card a { display: inline-flex; align-items: center; gap: 5px; color: var(--app-brand); font-size: 12px; font-weight: 900; text-decoration: none; }.home-saved-journey-card button { padding: 0; border: 0; background: transparent; color: var(--app-muted); cursor: pointer; font: inherit; font-size: 11px; font-weight: 800; }
